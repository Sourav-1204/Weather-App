...
export default function HourlyForecast() {
  ...
  return (
    <div className="size-full flex flex-col items-center">
      ...
      <div className="w-[70%] h-[75%] flex items-center justify-between gap-2 pl-1 overflow-x-scroll custom-scroll">
        {!loading && hourlyForecast.length > 0
          ? hourlyForecast.map((item, ind) => (
              <div
                className={`w-[30%] h-[100%] rounded-[30px] flex flex-col items-center justify-center px-3 py-1 ${
                  ind > 2
